...
class ArticleController extends AbstractController
{
    ...
    public function update($id, CandyRepository $repository,EntityManagerInterface $em): Response
    {
        ...
        // FindBy() permet de récupérer tou sles enregistrements de la base de données correspondent à des condistions sur les champs
...
// Creer une route / article/update 
//  ''                       delete